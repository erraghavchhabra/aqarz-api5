...
class Estate extends Model
{
    ...
    protected $appends = ['link','in_fav','operation_type_name', 'estate_type_name','first_image','city_name', 'neighborhood_name','estate_type_name_web','city_name_web','neighborhood_name_web'];
