    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if($request->get('type'))
        {
            ...
            $user = Admin::where($username_column, $credentials[$username_column])->first();
            ...
            if (!$user && $mobile) { //  TODO remove later after 2019-12-30
                ...
                $user = Admin::where($username_column, $mobile)->first();
            }
      ...
      */
                return JsonResponse::fail(__('views.UserPasswordMismatchError'), 400);
            }
           ...
           {
               return JsonResponse::fail(__('views.user is block'), 400);
           }
