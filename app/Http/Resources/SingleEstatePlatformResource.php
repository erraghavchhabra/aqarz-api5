...
class SingleEstatePlatformResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'group_estate_id'=>@$this->group_estate_id,
            'group_estate_name'=>@$this->estate_group->group_name,
            'EstateFile'=>@$this->EstateFile,
            'EstateCostExpense'=>@$this->EstateCostExpense,
