...
"Information that may affect the property,
 ...
 Advertiser's email
    ...
    <tr>
        ...
        <th>Information that may affect the property, whether in reducing its value or affecting the target's decision to advertise</th>
        ...
        <tr>
         ...
         <td>{{ $estateItem->pace_number != null ? @$estateItem->pace_number : '0' }}</td>
           ...
           <td>{{ $estateItem->parking_spaces_numbers!=null?'نعم':'لا' }}</td>
            ...
            <td>0</td>
            <td>0</td>
            <td>{{ @$estateItem->deleted_at }}</td>
            <td>{{ @$estateItem->reason }}</td>
