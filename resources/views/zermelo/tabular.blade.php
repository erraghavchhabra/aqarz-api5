                ...
                <div class="container-xxl">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table id="report_datatable" style="width:100%;"
                                           class="table align-middle gs-0 gy-2 text-center gx-2 fs-6 table-bordered">
                                                ...
                                                <div class="tab-pane fade show {{ ($loop->first) ?  'active' : '' }}"
                                                    ...
                                                    @foreach ( $wrench->sockets as $socket )
                                                        <div class="custom-control custom-radio">
                                                            <input
                                                                {{ $report->isActiveSocket($socket->id) ? 'checked' : '' }} type="radio"
                    ...
                    <form id="report-download-form" method="POST" action="{!! $download_uri !!}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="btn-group" style="display:flex;">
                                <input style="font-size:60%; width:100%" type="text" id="current-download-link"
                                       value=""/>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="button" id="initiate-report-download" class="btn btn-primary">Download
                            </button>
                        </div>
                    </form>
                </div>
    ...
    $(document).ready(function () {
        ...
        $.getJSON(
            ...
            data.columns.forEach(function (item) {
               ...
               // let translated = trans(item.title);
