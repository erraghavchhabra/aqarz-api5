            ...
            <div class="col-lg-12">
                <div class="congrets-card form-card">
                    <div class="card-form-left">
                        <img src="<?php echo e(asset('site/assets/img/card.png')); ?>" alt="">
                    </div>
...
<script>
  $('#payment_method').change( function() {
    ...
    if (paymentMethod == 'cc_merchantpage') {
      ...
      $.ajax({
        url: '<?php echo e(url('order')); ?>?payment_method=' + paymentMethod + '&uuid=<?php echo e($uuid); ?>&r=getPaymentPage',
        type: 'get',
        headers: {
   ...
   //  window.location.href = '<?php echo e(url('order')); ?>?payment_method=' + paymentMethod + '&uuid=<?php echo e($uuid); ?>&r=getPaymentPage';
    } else {
    ...
    <script type="text/javascript" src="<?php echo e(asset('img_pay/js/jquery.creditCardValidator.js')); ?>"></script>
